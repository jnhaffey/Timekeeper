...
namespace Microsoft.ALMRangers.Samples.MyHistory
{
    ...
    {
        public static readonly DependencyProperty ParentSectionProperty = DependencyProperty.Register("ParentSection", typeof(WorkItemsSection), typeof(WorkItemsSectionView));
        ...
        public WorkItemsSection ParentSection
        {
            get
            {
                return (WorkItemsSection)GetValue(ParentSectionProperty);
            }
