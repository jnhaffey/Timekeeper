...
namespace Microsoft.ALMRangers.Samples.MyHistory
{
    ...
    /// </summary>
    public partial class ShelvesetsSectionView
    {
        public static readonly DependencyProperty ParentSectionProperty = DependencyProperty.Register("ParentSection", typeof(ShelvesetsSection), typeof(ShelvesetsSectionView));

        public ShelvesetsSectionView()
        {
            this.InitializeComponent();
        }

        public ShelvesetsSection ParentSection
        {
            get
            {
                return (ShelvesetsSection)GetValue(ParentSectionProperty);
            }
